...
<div class="flex justify-between items-center mb-6">
    ...
    <div class="flex gap-2">
        <form action="{{ route('encadrant.ai.anomalies') }}" method="POST">
            @csrf
            <button type="submit"
...
<div class="mb-6 bg-amber-50 border border-amber-300 rounded-xl p-5">
    ...
    <div class="text-sm text-gray-700 whitespace-pre-line leading-relaxed">{{ session('ai_anomalies') }}</div>
</div>
@endif
